...
const KEY_MAP = {
  uhd: 'property_video_2160',
  hd: 'property_video_1080',
};

export default function PropertyVideoUploader({ target = 'uhd', onUpdated }) {
  ...
  const inputId = `propertyVideoUpload_${target}`;
  ...
  return (
    <div className="inline-flex items-center gap-2">
      ...
      <Button
        ...
        title={`Upload ${label} master for the property video`}
      >
