...
export default function FlowFarmHome() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#080c08", fontFamily: "Georgia, serif", color: "#fff" }}>
      ...
      <nav style={{
        ...
        padding: "24px 40px",
        background: "linear-gradient(to bottom, rgba(8,12,8,0.92), transparent)"
      }}>
        <div>
          <p style={{ color: "rgba(255,252,245,0.9)", fontSize: 12, letterSpacing: "0.35em", textTransform: "uppercase", margin: 0 }}>Flow Farm</p>
          <p style={{ color: "rgba(107,143,82,0.7)", fontSize: 9, letterSpacing: "0.5em", textTransform: "uppercase", margin: "3px 0 0" }}>107 Linden Trail · Aberdeen, NC</p>
        </div>
        <div style={{ display: "flex", gap: 28, alignItems: "center" }}>
          <a href="#opportunity" style={{ color: "rgba(255,255,255,0.35)", fontSize: 10, letterSpacing: "0.25em", textTransform: "uppercase", textDecoration: "none" }}>Estate</a>
          <a href="#farm" style={{ color: "rgba(255,255,255,0.35)", fontSize: 10, letterSpacing: "0.25em", textTransform: "uppercase", textDecoration: "none" }}>The Farm</a>
          <a href="#residence" style={{ color: "rgba(255,255,255,0.35)", fontSize: 10, letterSpacing: "0.25em", textTransform: "uppercase", textDecoration: "none" }}>Residence</a>
          <a href="/FlowFarmGallery" style={{ color: "rgba(255,255,255,0.35)", fontSize: 10, letterSpacing: "0.25em", textTransform: "uppercase", textDecoration: "none" }}>Gallery</a>
          <a href="#contact" style={{
            border: "1px solid rgba(107,143,82,0.6)", color: "#9ab87d",
      ...
      <div style={{ position: "relative", height: "100vh", minHeight: 700 }}>
        ...
        <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, padding: "0 48px 80px" }}>
          <p style={{ color: "rgba(154,184,125,0.8)", fontSize: 10, letterSpacing: "0.6em", textTransform: "uppercase", marginBottom: 20 }}>
            A Working Estate · Fifteen Acres
          </p>
          <h1 style={{ fontSize: "clamp(52px, 9vw, 110px)", fontWeight: 300, color: "rgba(255,252,245,0.9)", letterSpacing: "0.04em", margin: "0 0 20px", lineHeight: 1 }}>
            Flow Farm
          </h1>
          <p style={{ color: "rgba(255,255,255,0.45)", fontSize: 15, maxWidth: 560, marginBottom: 44, lineHeight: 1.85 }}>
          ...
          <div style={{ display: "flex", gap: 16, alignItems: "center", flexWrap: "wrap" }}>
            <a href="/FlowFarmGallery" style={{
              border: "1px solid rgba(107,143,82,0.7)", color: "#9ab87d", fontSize: 10,
        ...
        <div style={{ maxWidth: 960, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16, textAlign: "center" }}>
          {[["15","USDA Acres"],["7","Buildable Acres"],["3","Acre Veganic Farm"],["$5.26M","Offered At"]].map(([val, label]) => (
            <div key={label} style={{ padding: "8px 0" }}>
              <p style={{ fontSize: 32, fontWeight: 300, color: "rgba(255,252,245,0.85)", margin: "0 0 6px" }}>{val}</p>
      ...
      <div id="opportunity" style={{ maxWidth: 760, margin: "0 auto", padding: "100px 32px", textAlign: "center" }}>
        <div style={{ width: 1, height: 48, background: "rgba(107,143,82,0.3)", margin: "0 auto 52px" }} />
        <p style={{ color: "rgba(107,143,82,0.8)", fontSize: 9, letterSpacing: "0.6em", textTransform: "uppercase", marginBottom: 28 }}>The Opportunity</p>
        <h2 style={{ fontSize: "clamp(28px, 4vw, 44px)", fontWeight: 300, color: "rgba(255,252,245,0.85)", marginBottom: 28, lineHeight: 1.3 }}>
        ...
        <div style={{ width: 1, height: 40, background: "rgba(107,143,82,0.15)", margin: "0 auto" }} />
      </div>

      {/* Investment Summary Grid */}
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 24px 100px" }}>
        <div style={{ textAlign: "center", marginBottom: 52 }}>
          <p style={{ color: "rgba(107,143,82,0.7)", fontSize: 9, letterSpacing: "0.6em", textTransform: "uppercase", marginBottom: 16 }}>Investment Summary</p>
          <h2 style={{ fontSize: 32, fontWeight: 300, color: "rgba(255,252,245,0.8)", margin: 0 }}>The Strategic Value of the Land</h2>
        </div>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 1, background: "rgba(255,255,255,0.05)" }}>
          {[
            ...
            <div key={title} style={{ background: "#080c08", padding: "40px 32px" }}>
              <div style={{ width: 20, height: 1, background: "rgba(107,143,82,0.5)", marginBottom: 20 }} />
              <h3 style={{ fontSize: 13, fontWeight: 400, color: "rgba(255,252,245,0.85)", letterSpacing: "0.05em", marginBottom: 14, lineHeight: 1.4 }}>{title}</h3>
      ...
      <div id="farm" style={{ borderTop: "1px solid rgba(255,255,255,0.06)", padding: "100px 32px" }}>
        <div style={{ maxWidth: 760, margin: "0 auto", textAlign: "center", marginBottom: 64 }}>
          <div style={{ width: 1, height: 40, background: "rgba(107,143,82,0.3)", margin: "0 auto 48px" }} />
          <p style={{ color: "rgba(107,143,82,0.8)", fontSize: 9, letterSpacing: "0.6em", textTransform: "uppercase", marginBottom: 28 }}>The Farm</p>
          <h2 style={{ fontSize: 36, fontWeight: 300, color: "rgba(255,252,245,0.85)", marginBottom: 24, lineHeight: 1.3 }}>Veganic. Established. Running.</h2>
          <p style={{ color: "rgba(255,255,255,0.35)", fontSize: 15, lineHeight: 1.95, marginBottom: 16 }}>
            Operational since 2009. A 3-acre USDA-registered veganic farm with an established NC Qualifying Farmer Exemption. No pesticides, no chemicals — just plants feeding plants and land that gets better every season.
          </p>
        ...
        <div style={{ maxWidth: 1000, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 32 }}>
          {[
            ...
            ["High Tunnel Greenhouse", "96 x 36 ft high tunnel with a custom Climate Battery geothermal system. Extends the growing season for warm-season crops year-round."],
            ["Farm Workshop", "30 x 40 ft operational workshop with concrete slab, full electrical service, and dedicated 12 x 8 ft walk-in cooler for post-harvest storage."],
          ].map(([title, desc]) => (
            <div key={title} style={{ borderTop: "1px solid rgba(107,143,82,0.25)", paddingTop: 28 }}>
              <h3 style={{ fontSize: 12, fontWeight: 400, color: "rgba(255,252,245,0.8)", letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: 16 }}>{title}</h3>
        ...
        <div style={{ maxWidth: 760, margin: "64px auto 0", textAlign: "center" }}>
          <p style={{ color: "rgba(107,143,82,0.6)", fontSize: 9, letterSpacing: "0.5em", textTransform: "uppercase", marginBottom: 24 }}>Grown on the Land</p>
          <div style={{ display: "flex", flexWrap: "wrap", gap: 10, justifyContent: "center" }}>
            {["Tomatoes","Cucumbers","Leafy Greens","Herbs","Peppers","Squash & Zucchini","Strawberries","Potatoes","Hardy Kiwi","Cut Flowers"].map(crop => (
              <span key={crop} style={{
                ...
                fontSize: 10, letterSpacing: "0.2em", textTransform: "uppercase", padding: "8px 16px"
              }}>{crop}</span>
            ))}
          </div>
        </div>
      ...
      <div id="residence" style={{ borderTop: "1px solid rgba(255,255,255,0.06)", padding: "100px 32px" }}>
        <div style={{ maxWidth: 760, margin: "0 auto", textAlign: "center", marginBottom: 64 }}>
          <div style={{ width: 1, height: 40, background: "rgba(107,143,82,0.3)", margin: "0 auto 48px" }} />
          <p style={{ color: "rgba(107,143,82,0.8)", fontSize: 9, letterSpacing: "0.6em", textTransform: "uppercase", marginBottom: 28 }}>The Residence</p>
          <h2 style={{ fontSize: 36, fontWeight: 300, color: "rgba(255,252,245,0.85)", marginBottom: 24, lineHeight: 1.3 }}>
          ...
          <p style={{ color: "rgba(255,255,255,0.22)", fontSize: 15, lineHeight: 1.95 }}>
            Five ensuite bedrooms including two autonomous guest apartments. 60" Wolf dual fuel range. Sub-Zero suite. Concealed scullery. Walk-out lower level with Brown Safe vault. 20 geothermal wells. 14.3kW solar array.
          </p>
        </div>
        <div style={{ maxWidth: 900, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 1, background: "rgba(255,255,255,0.04)" }}>
          {[
            ...
            <div key={label} style={{ background: "#080c08", padding: "32px 28px", display: "flex", alignItems: "center", gap: 20 }}>
              <p style={{ fontSize: 20, fontWeight: 300, color: "rgba(255,252,245,0.85)", margin: 0, minWidth: 90 }}>{val}</p>
        ...
        {matterportUrl && (
          <div style={{ textAlign: "center", marginTop: 56 }}>
            <button onClick={() => setShowTour(true)} style={{
              background: "none", border: "1px solid rgba(107,143,82,0.6)", color: "#9ab87d",
              fontSize: 10, letterSpacing: "0.35em", textTransform: "uppercase",
      ...
      <div id="contact" style={{ borderTop: "1px solid rgba(255,255,255,0.06)", padding: "100px 32px", textAlign: "center" }}>
        <div style={{ width: 1, height: 40, background: "rgba(107,143,82,0.25)", margin: "0 auto 48px" }} />
        <p style={{ color: "rgba(107,143,82,0.7)", fontSize: 9, letterSpacing: "0.6em", textTransform: "uppercase", marginBottom: 20 }}>Private Showing</p>
        <h2 style={{ fontSize: 36, fontWeight: 300, color: "rgba(255,252,245,0.8)", marginBottom: 20 }}>Schedule a Private Viewing</h2>
        ...
        <a href="mailto:rachelhernandezrealtor@gmail.com" style={{
          border: "1px solid rgba(107,143,82,0.7)", color: "#9ab87d",
          fontSize: 10, letterSpacing: "0.35em", textTransform: "uppercase",
      ...
      {showTour && matterportUrl && (
        <div style={{ position: "fixed", inset: 0, zIndex: 100, background: "rgba(4,7,4,0.98)", display: "flex", alignItems: "center", justifyContent: "center" }}>
          <button onClick={() => setShowTour(false)} style={{
            ...
            color: "rgba(255,255,255,0.4)", cursor: "pointer", fontSize: 28, lineHeight: 1
          }}>✕</button>
