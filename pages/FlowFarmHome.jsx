...
export default function FlowFarmHome() {
  ...
  const s = {
    page: { minHeight: "100vh", fontFamily: "Georgia, serif", color: "#fff", background: "#080c08", overflowX: "hidden" },
    nav: { position: "fixed", top: 0, left: 0, right: 0, zIndex: 100, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "20px 40px", background: navScrolled ? "rgba(8,10,8,0.94)" : "transparent", backdropFilter: navScrolled ? "blur(20px)" : "none", WebkitBackdropFilter: navScrolled ? "blur(20px)" : "none", borderBottom: navScrolled ? "1px solid rgba(255,255,255,0.06)" : "none", transition: "all 0.4s ease" },
    hero: { position: "relative", height: "100vh", overflow: "hidden", background: "#000" },
    G: { background: "rgba(8,10,8,0.6)", backdropFilter: "blur(20px)", WebkitBackdropFilter: "blur(20px)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 2 },
    GL: { background: "rgba(8,10,8,0.35)", backdropFilter: "blur(14px)", WebkitBackdropFilter: "blur(14px)", border: "1px solid rgba(255,255,255,0.06)", borderRadius: 2 },
    section: { padding: "60px 32px 80px", maxWidth: 1100, margin: "0 auto" },
    eyebrow: { color: "rgba(160,190,130,0.65)", fontSize: 9, letterSpacing: "0.6em", textTransform: "uppercase", marginBottom: 14 },
    h2: { fontSize: "clamp(28px, 3.5vw, 46px)", fontWeight: 300, color: "rgba(255,252,245,0.88)", marginBottom: 44, lineHeight: 1.2 },
  };
    ...
    <div style={s.page}>
      ...
      {activeStructure && (
        <div style={{ position: "fixed", inset: 0, zIndex: 9998, background: "rgba(0,0,0,0.88)", display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }} onClick={() => setActiveStructure(null)}>
          <div style={{ ...s.G, maxWidth: 600, width: "100%", overflow: "hidden" }} onClick={(e) => e.stopPropagation()}>
            ...
            <div style={{ padding: "22px 26px 26px" }}>
              ...
              <button onClick={() => setActiveStructure(null)} style={{ ...s.GL, color: "rgba(255,255,255,0.3)", fontSize: 9, letterSpacing: "0.3em", textTransform: "uppercase", padding: "10px 20px", cursor: "pointer" }}>Close</button>
            </div>
          </div>
        </div>
      )}
      ...
      <nav style={s.nav}>
        ...
        <div style={{ display: "flex", gap: 28, alignItems: "center" }}>
          ...
          <a href="#contact" style={{ ...s.GL, color: "rgba(180,210,155,0.8)", fontSize: 9, letterSpacing: "0.25em", textTransform: "uppercase", padding: "10px 20px", textDecoration: "none" }}>Inquire</a>
        </div>
      </nav>
      ...
      <div style={s.hero}>
        ...
        <div style={{ position: "absolute", inset: 0, boxShadow: "inset 0 0 200px 50px rgba(0,0,0,0.22)" }} />
        ...
        <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", padding: "0 24px" }}>
          ...
          <h1 style={{ fontSize: "clamp(48px, 8.5vw, 104px)", fontWeight: 300, color: "#fff", margin: "0 0 24px", lineHeight: 0.95, textShadow: "0 2px 32px rgba(0,0,0,0.6)", letterSpacing: "0.01em" }}>
          ...
          <div style={{ display: "flex", gap: 10, flexWrap: "wrap", justifyContent: "center", marginBottom: 40 }}>
            {[["15 Acres","USDA Zoned"],["3 Miles","to Pinehurst"],["$5.26M","Offered At"],["6","Structures"]].map(([val, label]) => (
              <div key={label} style={{ ...s.GL, padding: "10px 20px", textAlign: "center" }}>
          ...
          <div style={{ display: "flex", gap: 12, alignItems: "center", flexWrap: "wrap", justifyContent: "center" }}>
            <button onClick={() => setShowMatterport(true)} style={{ ...s.G, color: "rgba(180,210,155,0.85)", fontSize: 9, letterSpacing: "0.35em", textTransform: "uppercase", padding: "14px 34px", cursor: "pointer" }}>
              Virtual Tour
            </button>
            <a href="https://portal.nucleus4d.com/3ec4ff02-9412-4f29-87ba-4926145df7a1/exterior-d302c992-e611-4197-b2df-ff6931a8827a" target="_blank" rel="noopener noreferrer" style={{ ...s.GL, color: "rgba(255,255,255,0.35)", fontSize: 9, letterSpacing: "0.35em", textTransform: "uppercase", padding: "14px 34px", textDecoration: "none" }}>
              Walk the Land
            </a>
          </div>
        </div>
      ...
      <div style={{ padding: "0 32px 60px" }}>
        <div style={{ ...s.G, maxWidth: 1040, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(6, 1fr)" }}>
      ...
      <div id="residence" style={{ padding: "40px 32px 80px" }}>
        <div style={s.section}>
          <p style={s.eyebrow}>The Residence</p>
          <h2 style={s.h2}>Designed by Robert Clark AIA.<br />One of His Final Works.</h2>
            ...
            <div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginBottom: 22 }}>
                {[["Kitchen","Sub-Zero suite + Wolf 60 inch range, double ovens, 2 KitchenAid dishwashers"],["Smart Home","Control4 audio/video/lighting + Araknis enterprise networking"],["Energy","20 geothermal wells, 61 solar panels, 30kW generator, 1,200 amp service"],["Basement","Media room, sauna, Brown Safe vault — all fully conditioned"]].map(([title, desc]) => (
                  <div key={title} style={{ ...s.GL, padding: "14px 13px" }}>
              ...
              <button onClick={() => setShowMatterport(true)} style={{ ...s.G, color: "rgba(180,210,155,0.8)", fontSize: 9, letterSpacing: "0.3em", textTransform: "uppercase", padding: "12px 26px", cursor: "pointer" }}>Interior Tour</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div id="farm" style={{ padding: "40px 32px 80px" }}>
        <div style={s.section}>
          <p style={s.eyebrow}>The Compound</p>
          <h2 style={s.h2}>Six Structures.<br />Every One with Purpose.</h2>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 10 }}>
            {structures.map((st) => (
              <div key={st.name} onClick={() => setActiveStructure(st)} style={{ ...s.G, cursor: "pointer", overflow: "hidden" }}>
      ...
      <div id="features" style={{ padding: "40px 32px 80px" }}>
        <div style={s.section}>
          <p style={s.eyebrow}>Property Features</p>
          <h2 style={s.h2}>Nothing Was Left Out.</h2>
          <div style={{ ...s.G, padding: "36px 32px" }}>
      ...
      <div id="location" style={{ padding: "40px 32px 80px" }}>
        <div style={{ ...s.section, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 52, alignItems: "center" }}>
          <div>
            <p style={s.eyebrow}>Location</p>
            <h2 style={s.h2}>Private by Nature.<br />Pinehurst by Proximity.</h2>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
              {[["3 Miles","Historic Village of Pinehurst"],["Minutes","Moore County Regional Airport"],["1 Hour","Raleigh-Durham International"],["Nearby","FirstHealth Moore Regional Hospital"]].map(([val, label]) => (
                <div key={label} style={{ ...s.GL, padding: "13px 12px" }}>
      ...
      <div id="contact" style={{ padding: "60px 32px 100px", textAlign: "center" }}>
        <div style={{ maxWidth: 560, margin: "0 auto" }}>
          <p style={s.eyebrow}>Private Inquiry</p>
          ...
          <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
            <a href="mailto:rachelhernandezrealtor@gmail.com" style={{ ...s.G, color: "rgba(180,210,155,0.85)", fontSize: 9, letterSpacing: "0.35em", textTransform: "uppercase", padding: "14px 32px", textDecoration: "none" }}>Email Rachel</a>
            <button onClick={() => setShowMatterport(true)} style={{ ...s.GL, color: "rgba(255,255,255,0.32)", fontSize: 9, letterSpacing: "0.35em", textTransform: "uppercase", padding: "14px 32px", cursor: "pointer" }}>Virtual Tour</button>
          </div>
        </div>
      </div>

      {/* FOOTER */}
      <div style={{ ...s.G, borderRadius: 0, borderLeft: "none", borderRight: "none", borderBottom: "none", padding: "22px 40px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div>
